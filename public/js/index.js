async function cargarProductos(){
    ...
    products.forEach(function(product){
        ...
        spanBrand.innerHTML = product.Brand.name;
        li.appendChild(spanBrand);
        let imgBrand = document.createElement('img');
        imgBrand.src= "/img/brands/"+product.Brand.logo;
        li.appendChild(imgBrand);

        product.Categories.forEach(category => {
            // Categoría
            let spanCat = document.createElement('span');
            spanCat.innerHTML = category.name;
